    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          {r.respondentEmail} · submitted {new Date(r.submittedAt).toLocaleString("en-GB", { dateStyle: "medium", timeStyle: "short" })}
        </p>
      </div>
      ...
      <div className="rounded-2xl bg-card border p-6 space-y-4">
        <div>
          <h2 className="text-xs uppercase tracking-wider text-muted-foreground font-semibold mb-2">Will attend NAS 2028?</h2>
        ...
        <div>
          <h2 className="text-xs uppercase tracking-wider text-muted-foreground font-semibold mb-2">What should we improve?</h2>
