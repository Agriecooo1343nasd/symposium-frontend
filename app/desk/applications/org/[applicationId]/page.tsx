...
export default function DeskOrgApplicationDetailPage() {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-md border border-blue/30 bg-blue/5 p-4 text-sm space-y-2">
        ...
        <p className="text-muted-foreground">
          The organization pays the booth/sponsor package below. <strong>Invited staff do not pay individually</strong>{" "}
          — they receive comp passes and check in with{" "}
          <code className="text-xs bg-secondary px-1 rounded">STAFF-*</code> QR codes at the desk.
        </p>
      ...
      {tier && (
        <div className="rounded-md bg-secondary/40 border border-border p-5 text-sm">
          <h3 className="font-serif font-bold mb-2">{tier.tier} package (admin)</h3>
          <p>
